...
public class P40_IsAnagram {
	...
	static void isAnagram(String str1, String str2) {
		...
		// executes if lengths of strings are equal
			...
			// first converts the string 1 in lower case and then converts the string into a
			// character array
			// final string stores in arrayS1
			char[] arrayS1 = s1.toLowerCase().toCharArray();
			// first converts the string 2 in lower case and then converts the string into a
			// character array
